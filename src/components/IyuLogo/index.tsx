...
export const IyuLogo: React.FC<Props> = (props) => (
  ...
  >
    <defs>
      <style>
        {`
      .cls-1{fill:#00aecb;}.cls-2{fill:#e85382;}.cls-3{fill:#ffd800;}.cls-4{fill:#c3d600;}.cls-5{fill:#a54a96;}
      `}
      </style>
    </defs>
    <title>iyu-logo-RGB</title>
    <rect className="cls-1" x="77.78" y="172.89" width="127.74" height="233.48" />
    <polygon
      className="cls-2"
    ...
    />
    <rect className="cls-4" x="754.48" y="172.89" width="127.74" height="233.48" />
    <path
      className="cls-5"
